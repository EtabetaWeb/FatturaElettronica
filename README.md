...
* Documenti/File Dati: file txt contenenti i codici elencati nella parte II del documento di specifiche tecniche
* Documenti/File Dati: file txt contenenti i codici elencati nella parte II del documento di specifiche tecniche
* FatturaEL.v13: classi per la definizione del file XML (basato sulle specifiche tecniche della versione 1.3) 
* GeneraFatturaEL.v13: form per la generazione del file XML (basato sulle specifiche tecniche della versione 1.3) 

# Versione obsoleta
* FatturaPA.v12: classi per la definizione del file XML (basato sulle specifiche tecniche della versione 1.2)
* GeneraFatturaPA.v12: form per la generazione del file XML (basato sulle specifiche tecniche della versione 1.2) 
